...
const CHAIN_DESC: { re: RegExp; text: string }[] = [
  ...
  { re: /denny|デニーズ/i, text: "全国展開するファミリーレストラン「デニーズ」です。多くの店舗でフリーWi-Fiとドリンクバーが使え、電源のある席を備えた店舗もあります。深夜まで営業する店舗も多く、長めの作業や休憩に便利です。" },
  { re: /saizeriya|サイゼリヤ/i, text: "リーズナブルなイタリアンのファミリーレストランです。ドリンクバーがあり長居しやすく、店舗によってはWi-Fiや電源も使えます。気軽な作業や休憩に向いています。" },
  { re: /freshness|フレッシュネス/i, text: "国産食材にこだわる、居心地のよいハンバーガーチェーンです。多くの店舗でフリーWi-Fiが使え、電源のある席を備えた店舗もあり、短時間の作業や休憩に向いています。" },
];
