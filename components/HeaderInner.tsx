  ...
  return (
    <div className="site-header-inner">
      <Link href={localePath("/", locale)} className="brand" aria-label={`${SITE.name} — home`}>
        {/* Baloo 2 text wordmark: coral cup + coral "Working" + themed "Cafes".
            Cup viewBox matches the favicon so the CSS height/nudge aligns it to the W. */}
        <svg className="brand-mark" viewBox="2.0 3.4 16 16" aria-hidden="true" focusable="false" fill="none">
